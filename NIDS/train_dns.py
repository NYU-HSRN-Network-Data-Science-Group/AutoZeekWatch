"""
This file contains code to train an AE-based model for dns.log data using the parameters from the best model.
Arguments: the dates of the data to be trained on.
#TODO: change to AE instead of KitNet 

Command: python train_dns.py --log-dir /usr/local/logs
...
def main():
    ...
    parser.add_argument('--model-path', type=str, default='kit_dns.joblib',  
